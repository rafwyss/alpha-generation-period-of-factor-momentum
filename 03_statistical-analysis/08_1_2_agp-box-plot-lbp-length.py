...
--------------------------------------------------------------------
Data visualization Python-Script Nr. 8.1.2
********************************************************************
BOX PLOT FOR AGP RESULTS 1971-2021 SEGMENTED BY LBP-LENGTHS
********************************************************************
This file allows the generation of a box plot of AGP results over 
the entire period from 1971 to 2021, segmented by LBP-lengths.
The file also allows for further segmentation by percentiles.
"""
...
# Options: For no further segmentation: 'none'. For further segmentation by percentiles: 'percentiles'.
segmentation = 'percentiles'
...
if segmentation == 'none':
    ...
    boxplot = sns.boxplot(data=df, x='lbp_length', y='amount_of_months',
    ...
    plt.savefig(os.path.join('08_visualizations',f'agp_boxplot_lbp_length_{ret_w}.png'), dpi=800, bbox_inches='tight')
...
# FURTHER SEGMENTATION BY PERCENTILES
    ...
    plt.savefig(os.path.join('08_visualizations',f'agp_boxplot_lbp_length_{ret_w}_by_percentiles.png'), dpi=800, bbox_inches='tight')