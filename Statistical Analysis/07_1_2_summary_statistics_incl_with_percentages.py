...
print(summary_stats)
summary_stats.to_csv('agp_summary_statistics_incl_with_percentages.csv')
print(f'CSV-File exported under the name: agp_summary_statistics_incl_with_percentages.csv')
